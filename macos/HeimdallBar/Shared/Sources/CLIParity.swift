...
private struct CLIOptionAllowance {
    ...
    static let usage = CLIOptionAllowance(provider: true, source: true, format: true, pretty: true, status: true, refresh: true)
    static let cost = CLIOptionAllowance(provider: true, source: true, format: true, pretty: true, status: true, refresh: true)
    static let configValidate = CLIOptionAllowance(provider: false, source: false, format: true, pretty: true, status: false, refresh: false)
    static let configDump = CLIOptionAllowance(provider: false, source: false, format: true, pretty: true, status: false, refresh: false)
}
